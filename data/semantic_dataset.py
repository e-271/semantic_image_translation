...
import numpy as np
#TODO(esther): Preprocess the sentences using infersent and put them somewheres (or should I do it here?)
#TODO(si): Once this class is set up, Si can generate images in the same format as edges2shoes, and this will read them and stuff.

class SemanticDataset(BaseDataset):
    """AlignedDataset with semantic information.

    It assumes that the directory '/path/to/data/train' contains image pairs in the form of {A,B} and sentences.
